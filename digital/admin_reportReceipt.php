 ...
 <p style="font-family: Calibri (Body); font-weight: bold; font-size: 14px; margin-left: 20px; float: left">Printed on: <?php echo date("l jS \of F "). "," . " " . date('H:i:s'); ?></p>
  <table width="760px" style="margin-left: auto; margin-right: auto;  border: 1px dashed #000000;" cellpadding="0" cellspacing="0" border="1">
	   <tr>
	    ...
	    <tr>
			<td width="20%" style='font-family: arial black; text-align: center; font-size: 11px; border: 1px dashed #000000;'><b>One Hour N</b></td>
			<td width="20%" style='font-family: arial black; text-align: center; font-size: 11px; border: 1px dashed #000000;'><b>Two Hours N</b></td>
			<td width="20%" style='font-family: arial black; text-align: center; font-size: 11px; border: 1px dashed #000000;'><b>Printing N</b></td>
			<td width="20%" style='font-family: arial black; text-align: center; font-size: 11px; border: 1px dashed #000000;'><b>Scanning N</b></td>
			<td width="20%" style='font-family: arial black; text-align: center; font-size: 11px; border: 1px dashed #000000;'><b>Training N</b></td>
		</tr>
