...
$nodata = "";
$hospital_data = "";
$clinic = "Gynaecology clinic";
$sub_clinic1 = "infertility";
$sub_clinic2 = "pregnancy clinic";
$sub_clinic3 = "Post-partum clinic";
$sub_clinic4 = "general gynaecology issue";
// view for hospital data
$selectview = "SELECT * FROM doctor_panel WHERE clinic='".$clinic."' || sub_clinic1='".$sub_clinic1."' || sub_clinic1='".$sub_clinic2."' || sub_clinic1='".$sub_clinic3."' || sub_clinic1='".$sub_clinic4."' ORDER BY date ASC";
...
<title>Gynaecology Clinic</title>
</head>
<body>
<?php
     ...
     <div class="margin" id="content">
	  <div class="welcome_message">
	   <h1 style='text-align: center; font-family: tahoma; font-size: 16px; text-transform: uppercase; font-weight: bold; background-color: #000000; margin-top: -5px; color: #CECECE'>Welcome <?php echo "Doctor" . " " .$name."!"; ?> What would you like to do today?</h1>
	    <h2 style='margin-left: 0px; font-family: Calibri (Body); font-size: 22px; font-weight: bold; text-transform: uppercase; font-style: normal; color: #880000; text-shadow: 0 1px 0 #ccc,0 2px 0 #c9c9c9,0 3px 0 #bbb,0 4px 0 #b9b9b9,0 5px 0 #aaa,0 6px 1px rgba(0,0,0,.1),0 0 5px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.3),0 3px 5px rgba(0,0,0,.2),0 5px 10px rgba(0,0,0,.25),0 10px 10px rgba(0,0,0,.2),0 20px 20px rgba(0,0,0,.15)'>Available Patients in Gynaecology Clinic</h2>
	   </div><br>
