		    ...
		    <legend>Next Of Kin</legend>
			  <div class="form">
			   ...
			   <tr>
				 ...
				 <td width="70%"><input type="text" class="userarea" name="nextofkinName" value= "<?=@$kinname?>"></td>
			  </tr>
			  <tr>
			     <td width="30%"><label>Phone No</label></td>
				 <td width="70%"><input type="text" class="userarea" name="phone1"  value= "<?=@$kinphone?>"></td>
			  </tr>
			  <tr>
				<td width="30%"><label>Relationship</label></td>
				<td width="70%"><input type="text" class="userarea" name="relationship1"  value= "<?=@$rela?>"></td>
			  </tr>
			  <tr>
				 <td width="30%"><label>Address</label></td>
				 <td width="70%"><textarea type="textarea" cols="30" rows="5" class="userarea" name="address1"><?php echo $add; ?></textarea></td>
			  </tr>
			 </fieldset>
			</table><br>
