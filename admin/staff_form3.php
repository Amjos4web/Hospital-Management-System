...
if (isset($_POST['back'])){
	header ('location: staff_form2.php');
}
?>
<!DOCTYPE html>
<html>
			...
			<?php echo $msg; ?>
			  <div class="form_btn">
			   <form action="" method="post">
				 ...
				 <p><input type="text" class="userarea_form" name="school1" placeholder="Name of School">From<select name="schoolStart1" class="user">
		        ...
		        <input type="submit" value="SUBMIT" name="proceed" id="proceed2"></center>
		 </form>
		 </div>
		</div>
