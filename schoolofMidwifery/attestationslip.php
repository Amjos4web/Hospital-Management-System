   ...
   <div id="containerr">
     ...
     <div class="print_profiledata">
	  <p>Attesttation</p>
	     ...
	     <section><label style='margin-left: 15px; font-family: Calibri (Body); font-size: 16px; font-weight: bold'>Full Name</label><p style='float: right; margin-right: 190px; font-family: Bradley Hand ITC; font-size: 13px; font-weight: bold'><input type="text" class="usertext" disabled="disabled"></p></section><br>
		 <section><label style='margin-left: 15px; font-family: Calibri (Body); font-size: 16px; font-weight: bold'>Email Address</label><p style='float: right; margin-right: 190px;  font-family: Bradley Hand ITC; font-size: 13px; font-weight: bold'><input type="text" class="usertext" disabled="disabled"></p></section><br>
		 <section><label style='margin-left: 15px; font-family: Calibri (Body); font-size: 16px; font-weight: bold'>Contact Address</label><p style='float: right; margin-right: 190px;  font-family: Bradley Hand ITC; font-size: 13px; font-weight: bold'><input type="text" class="usertext" disabled="disabled"></p></section><br>
		 <section><label style='margin-left: 15px; font-family: Calibri (Body); font-size: 16px; font-weight: bold'>Phone No</label><p style='float: right; margin-right: 190px;  font-family: Bradley Hand ITC;  font-size: 13px; font-weight: bold'><input type="text" class="usertext" disabled="disabled"></p></section><br>
		 <section><label style='margin-left: 15px; font-family: Calibri (Body); font-size: 16px; font-weight: bold'>Occupation</label><p style='float: right; margin-right: 190px;  font-family: Bradley Hand ITC; font-size: 13px; font-weight: bold'><input type="text" class="usertext" disabled="disabled"></p></section><br>
