  ...
  <div id="sidebar1"><br>
	...
	<?php include_once "../new_bar.php"; ?>
	 ...
	 <div class="margin" id="content">
	  <div id="patient_form">
	  	  	<table width="760px" style="margin-left: auto; margin-right: auto; margin-top: auto;" cellpadding="1" cellspacing="0" border="1">
		<tr>
			...
			<td width="13%" style='background-color:#C5DFFA; font-family: arial black; text-align: center; font-size: 14px'><b>Edit</b></td>
		</tr>
