  ...
  <div id="containerr">
   ...
   <div class="date">
	 ...
	 <form action="" method="post">
	  ...
	  <section><label style='font-family: Tahoma; font-size: 16px; margin-left: 35px; text-transform: uppercase'>Examination Date: </label>
	  <label style='color: #fff; font-size: 16px; font-family: Tahoma; background-color: #000000'>06 May, 2017 </label><label style='font-family: Tahoma; font-size: 16px; margin-left: 15px; text-transform: uppercase'>Time: </label><label style='color: #fff; font-size: 16px; font-family: Tahoma; background-color: #000000'>8am</label><label style='font-family: Tahoma; font-size: 16px; margin-left: 15px; text-transform: uppercase'>Examination Center: </label><label style='color: #fff; font-size: 16px; font-family: Tahoma; background-color: #000000'>School Premises</label></section><br><br><br>
       <section>
	   ...
	   <section>
        <p style='text-align: center; font-family: Tahoma; font-size: 14px; color: #000000; text-transform: none'>Note: Please bring this slip to the examination and interview venues (Print 2 Copies)</p>
	   </section>
   </div>
  </div>
