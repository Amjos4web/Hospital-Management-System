...
<head>
	...
	<title>BUTH School of Nursing Upload Passport Page</title>
	<link href="http://localhost/nursingSchool/css/buth_net.css" rel="stylesheet" type="text/css" />
         ...
         <div id="pageContent">
             <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
			   <h1 style="color: #880000; font: 22px monospace; word-spacing: 10px;">Upload Passport</h1>
                <div align="center" class="calendarText"><span class="subHeader">Student ID:</span> <?php echo "BUTH/SON/" . $studentID; ?><br />
                    <img style="border: 3px groove #CECECE; padding-left: 0px; margin-right: 15px;" src="../nursingSchool/passports/<?php echo $studentID; ?>.jpg" alt="" width="160px" height="160px" class="image"><br>
                 </div><br>
			    <div class="buttons">
