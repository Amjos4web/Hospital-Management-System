...
if (isset($_POST['proceed'])){
	...
	if (empty($school1 && $schoolStart1 && $schoolStop1) == false)
	{
		...
		{
		$sql = "UPDATE `sono_nextofkin` SET `school1`='$school1', `from1`='$schoolStart1', `to1`='$schoolStop1', `school2`='$school2', `from2`='$schoolStart2', `to2`='$schoolStop2', `school3`='$school3', `from3`='$schoolStart3', `to3`='$schoolStop3', `school4`='$school4', `from4`='$schoolStart4', `to4`='$schoolStop4' WHERE `eMail`='$email'";
...
<title>Education/School of Nursing</title>
</head>
<body>
<?php
...
<div id="container">
  <div id="sidebar1"><br>
   ...
   <ul id="navigation2">
	...
	<img src="images/Bowen5.jpg" width="170px" height="250px" style="margin-left: 20px" alt="Welcome To School of Nursing"><br><br>
