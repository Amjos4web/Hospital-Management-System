	...
	if (empty($nextofkinName && $phone1 && $relationship1 && $address1 && $sponsorname && $phone2 && $relationship2 && $address2) == false)
	{
		if ((strlen($_POST['address1']) < 50) || (strlen($_POST['address2']) < 50))
		{
			if ((preg_match("/^[0-9]{11}$/", $phone1)) || (preg_match("/^[0-9]{11}$/", $phone2)))
				{
					$sql = "UPDATE `sono_nextofkin` SET `studentid`='$studentID', `Nameofkin`='$nextofkinName', `phoneNo1`='$phone1', `relationship1`='$relationship1', `address1`='$address1', `sponsorName`='$sponsorname', `phoneNo2`='$phone2', `address2`='$address2', `relationship2`='$relationship2', `date_added`='$date_added' WHERE `email`='$email'";
					$check = mysqli_query($dbconnect, $sql);
...
<!DOCTYPE html>
<html>
<link href="http://10.40.255.5/buth_net/nursingSchool/css/buth_net.css" rel="stylesheet" type="text/css">
<head>
<meta charset="utf-8">
<link rel="shortcut icon" href="/favicon.ico" >
<script src="js/jquery.js" type="text/javascript"></script>
<script src="js/jqueryy.js" type="text/javascript"></script>
<title>Next of Kin/School of Nursing</title>
</head>
<body>
<?php
