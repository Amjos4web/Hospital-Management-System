...
if($resultCount>0){
	while($row=mysqli_fetch_array($check2))
	{
		...
		$successmsg2 .= $email; 
		$successmsg4 .= "<p style='text-align: center; font-family: Tahoma; color: #880000; font-weight: bold; font-size: 14px; padding-top: 10px'>You have successfully paid for your 2017 Admission form, and the bank details will be verified soon. Your pin to registration is</p>"; 
		$successmsg3 .= $Pin; 
