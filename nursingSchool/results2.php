...
if (isset($_POST['add']) && ($_POST['filename'] == "waec"))
{
	...
	if ($tmpFilePath != "")
	{
		...
		{ 
			...
			$uploaderror = "<p style='color: #D8000C; background-color: #FFBABA; border-radius:.5em; width: 300px; border: 1px solid #D8D8D8; padding: 5px; border-radius: 5px; margin-left: auto; margin-right: auto; font-family: Arial; font-size: 11px; text-transform: uppercase; text-align: center; text-transform: uppercase'>File not in correct format</p>";
		}
	} else {
...
if (isset($_POST['proceed']) && file_exists($path)){
