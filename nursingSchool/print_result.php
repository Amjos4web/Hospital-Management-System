...
if (isset($_GET['student_id'])){
	...
	$sql6 = "SELECT * FROM sono_firstyearresult1 WHERE `student_id`='".$student_id."' LIMIT 1";
	...
	if ($resultCount6>0){
		while($row=mysqli_fetch_array($check6)){
			...
			$update = "UPDATE `sono_firstyearresult1` SET `firstyear_cumulative_avg`='".$cumulative."' WHERE `eMail`='".$email."' LIMIT 1";
			$checkupdate = mysqli_query($dbconnect, $update) or die(mysqli_error($dbconnect));
		}
	} else {
...
<div id="requisition_receipt" style="width: 800px; min-height: 300px; margin-left: auto; margin-right: auto">
 ...
 <p style="text-align: center; font-size: 16px; font-family: arial">School Of Nursing</p>
 <center><h3 class="heading_text" style="width: 400px">1st Year 1st Semester Results</h3></center>
	...
	<br><br>
	  <div class="dynamic_table">
	    <?php //echo $nodata; ?>
	    <table cellpadding="2" cellspacing="2" border="1" style='margin-left: auto; margin-right: auto;'>
		   <tr>
		...
		<center><h3 class="heading_text" style="width: 400px">Cumulative Average = <?php echo $cumulative; ?></h3></center>
		<center><label style="font-family: monospace;">Signed</label></center>
		<center><label style="font-family: cursive;">Principal</label></center>
