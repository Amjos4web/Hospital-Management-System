...
if (isset($_GET['from_date']) && ($_GET['to_date'])){
	...
	// display the specified information
		$display = "SELECT * FROM `transactions` WHERE `payment_date` >= '$from_date' AND `payment_date` <= '$to_date' AND `others`='" . $others. "'";
		...
		if ($displayResult > 0){
			while($row=mysqli_fetch_assoc($displayCheck)){
				...
				$dynamic_list .= "<td style=' text-align: center; font-family: Adobe Heiti Std R; border: 1px dashed #000000'>".$signed . "</td>";
				$dynamic_list .= "<td style=' text-align: center; font-family: Adobe Heiti Std R; border: 1px dashed #000000'>".$otherss . "</td>";
...
<title>Income Summary for <?php echo $others; ?></title>
</head>
<body>
<div id="requisition_receipt" style="width: 800px; min-height: 300px; margin-left: auto; margin-right: auto">
 ...
 <p style="text-align: center; font-size: 16px; font-family: arial">Income Summary For <?php echo $others." "; ?>From: <?php echo $from_date. " "; ?>To:<?php echo " " . $to_date; ?></p>
 <p style="font-family: Calibri (Body); font-weight: bold; font-size: 14px; margin-left: 20px; float: left"><?php echo date("l jS \of F Y"). "," . " " . date('H:i:s'); ?></p>
  <table width="760px" style="margin-left: auto; margin-right: auto" cellpadding="2" cellspacing="0" border="0">
   <tr>
	   <td width="25%" style=' font-family: arial black; text-align: center; font-size: 14px; border: 1px dashed #000000'><b>Date</b></td>
		<td width="20%" style=' font-family: arial black; text-align: center; font-size: 14px; border: 1px dashed #000000'><b>Receipt No</b></td>
		<td width="15%" style=' font-family: arial black; text-align: center; font-size: 14px; border: 1px dashed #000000'><b>Signed By</b></td>
		<td width="20%" style=' font-family: arial black; text-align: center; font-size: 14px; border: 1px dashed #000000'><b>Receipt For</b></td>
		<td width="20%" style=' font-family: arial black; text-align: center; font-size: 14px; border: 1px dashed #000000'><b>Total Income N</b></td>
		</tr>
