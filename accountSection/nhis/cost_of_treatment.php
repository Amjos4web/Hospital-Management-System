...
if (isset($_POST['submit'])){
	...
	if (empty($hmo && $amount && $month && $year) == false){
		$date = $year . "-" . $month;
		$insert = "INSERT INTO cs_of_trt (`hmo`, `amount3`, `date`) VALUES ('$hmo', '$amount', '$date')";
    ...
    <ul id="navigation2">
     ...
     <div class="margin" id="content">
		<div class="payment_form2" style="min-height: 250px">
		 ...
		 <div class="form_data">
		 <h3 style='text-align: center; font-family: Calibri (Body); font-size: 22px; font-weight: bold; text-transform: uppercase; font-style: normal; color: #880000; text-shadow: 0 1px 0 #ccc,0 2px 0 #c9c9c9,0 3px 0 #bbb,0 4px 0 #b9b9b9,0 5px 0 #aaa,0 6px 1px rgba(0,0,0,.1),0 0 5px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.3),0 3px 5px rgba(0,0,0,.2),0 5px 10px rgba(0,0,0,.25),0 10px 10px rgba(0,0,0,.2),0 20px 20px rgba(0,0,0,.15)'>Cost of treatment Form</h3>
		 <?php echo $msg; ?>
