...
<?php
$dynamic_list = "";
if (isset($_GET['choose_year']) && ($_GET['staff_id'])){
	$search = $_GET['staff_id'];
...
<title>Individual Pension for <?php echo $search; ?></title>
</head>
<body>
<div id="requisition_receipt" style="width: 800px; min-height: 300px; margin-left: auto; margin-right: auto">
 ...
 <p style="text-align: center; font-size: 16px; font-family: arial">Individual Pension List For <?php echo $search; ?> in <?php echo $choose_year; ?></p>
