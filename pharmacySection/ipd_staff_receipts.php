...
if($resultCount8>0){
	...
	$id=$row["id"];
	$staff_name=$row["patient_name"];
	$staff_id=$row["hospital_no"];
...
<div id="receipt_wrapper" style="width: 272px; height: 756px; margin-left: auto; margin-right: auto">
  ...
  <label style="font-family: Calibri (Body); font-weight: bold; font-size: 13px"><?php echo "Payer ID:" . " " .$staff_name; ?></label>
  <label style="float: right; font-family: Calibri (Body); font-weight: bold; font-size: 14px"><?php echo "Hosp. No:" . " " .$staff_id; ?></label>
