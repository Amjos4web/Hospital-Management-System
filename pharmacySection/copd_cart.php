...
if(!isset($_SESSION['CartArray']) || count($_SESSION['CartArray']) < 1){
	...
	foreach ($_SESSION['CartArray'] as $each_item){
		...
		$sql2 = "SELECT * FROM `copd_pharm_req` WHERE `id`='$item_id'";
...
<div id="container">
  <div id="sidebar1"><br>
    ...
    <ul id="navigation2">
	  ...
	  <li><a href="copd_payment_verification.php">Payment Verification</a></li><br>
      <li><a href="copd_dashboard.php">Drugs</a></li><br>
      <li><a href="copd_cart.php">Billing</a></li><br>
  ...
  <div class="margin" id="content">
	<div class="product_details">										
	 ...
	 <div class="form_table1" style="display: none">
	   <form action="copd_receipt.php" method="POST" id="jsform" class="form1" target="_blank">
	   ...
	   <form action="copd_staff_receipt.php" method="POST" id="jsform2" class="form2"  target="_blank">
	   ...
	   <form action="copd_sem_receipt.php" method="POST" id="jsform3" class="form3"  target="_blank">
	   ...
	   <form action="copd_nhis_receipt.php" method="POST" id="jsform4" class="form4" target="_blank">
	   ...
	   <tr>
		...
		<label class="add_more_drugs" style="float: right"><a href='copd_dashboard.php'>Add More Drugs</a></label>
	   ...
	   <h2 class="empty"><a href='copd_cart.php?cmd=emptycart'>Click here to empty your cart</a></h2>
          <hr style='width: 800px; margin-left: 0px; height: 6px; background-color: #14BCEB'><br>
	<!-- end .margin --></div>
  <!-- end .container --></div>
 <?php
