...
if (isset($_GET['id'])){
	...
	// give message
	$sql6 = "SELECT * FROM `pead_pharm_req` WHERE `id`='$product_id' LIMIT 1";
...
<div id="container">
  <div id="sidebar1"><br>
    ...
    <ul id="navigation2">
	  ...
	  <li><a href="pead_pharm_dashboard.php">Peadeterics Pharmacy</a></li><br>
	...
	<h2 class='add_more3'><p><?php echo "Quantity Available:" . " " . "[" .$quantity_available. "]"; ?></p></h2><br><br><br><br>
	 <table width="480px" style="margin-left: auto; margin-right: auto" cellpadding="10"  cellspacing="0" border="1">
	    ...
	    ?>
		   ...
		   <form action="pead_cart.php" method="post" name="Cart4">
