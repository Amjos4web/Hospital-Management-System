...
if(!isset($_SESSION['CartArray2']) || count($_SESSION['CartArray2']) < 1){
	...
	foreach ($_SESSION['CartArray2'] as $each_item){
		...
		while ($row2=mysqli_fetch_array($check2)){
			...
			$cartOutput .= "<tr>";
			$cartOutput .= "<td style='font-family: Adobe Heiti Std R; font-size: 9px; border: 1px dashed #000000'>" . $item_id . "</td>";
			$cartOutput .= "<td style='font-family: Adobe Heiti Std R; font-size: 9px; border: 1px dashed #000000'>" . $product_name . "</td>";
			$cartOutput .= "<td style='font-family: Adobe Heiti Std R; font-size: 9px; border: 1px dashed #000000'>" . $category . "</td>";
			$cartOutput .= "<td style='font-family: Adobe Heiti Std R; font-size: 9px; border: 1px dashed #000000'>" . $drug_type . "</td>";
			$cartOutput .= "<td style='font-family: Adobe Heiti Std R; font-size: 9px; border: 1px dashed #000000'>" . $quantity . "</td>";
			$cartOutput .= "<td style='font-family: Adobe Heiti Std R; font-size: 9px; border: 1px dashed #000000'>N" . $product_price . "</td>";
			$cartOutput .= "</tr>";
		}
	}
}
...
<div id="requisition_receipt" style="width: 600px; min-height: 300px; margin-left: auto; margin-right: auto">
 ...
 <p style="text-align: center; font-size: 16px; font-family: arial">Requisition Forwarded To Accidental and Emergency Pharmacy Section</p>
 <p style="font-family: Calibri (Body); font-weight: bold; font-size: 9px; float: left"><?php echo date("l jS \of F Y"). "," . " " . date('H:i:s'); ?></p>
  <table width="600px" style="margin-left: auto; margin-right: auto" cellpadding="0" cellspacing="0" border="1">
   <tr>
