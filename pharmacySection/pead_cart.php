...
<div id="container">
  <div id="sidebar1"><br>
    ...
    <ul id="navigation2">
	  ...
	  <li><a href="pead_pharm_dashboard.php">MCH Pharmacy</a></li><br>
	...
	<div class="product_details">
	 ...
	 <h2 style='text-align: center; font-family: Calibri (Body); font-size: 22px; text-transform: uppercase; font-style: normal; color: #880000; text-shadow: 0 1px 0 #ccc,0 2px 0 #c9c9c9,0 3px 0 #bbb,0 4px 0 #b9b9b9,0 5px 0 #aaa,0 6px 1px rgba(0,0,0,.1),0 0 5px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.3),0 3px 5px rgba(0,0,0,.2),0 5px 10px rgba(0,0,0,.25),0 10px 10px rgba(0,0,0,.2),0 20px 20px rgba(0,0,0,.15); font-style: normal'>Your Cart</h2>
	  ...
	  <div class="form_table1" style="display: none">
	   <form action="pead_receipt.php" method="POST" id="jsform" class="form1" target="_blank">
	   ...
	   <form action="pead_staff_receipt.php" method="POST" id="jsform2" class="form2"  target="_blank">
	   ...
	   <form action="pead_sem_receipt.php" method="POST" id="jsform3" class="form3"  target="_blank">
	   ...
	   <form action="pead_nhis_receipt.php" method="POST" id="jsform4" class="form4" target="_blank">
	   ...
	   <tr>
		...
		<center><?php echo $cartOutput; ?></center>
	    <?php
	    echo $msg;
	    ?>
		<!--tr>
		...
		<label class="add_more_drugs" style="float: right"><a href='pead_pharm_dashboard.php'>Add More Drugs</a></label>
	   ...
	   <h2 class="empty"><a href='pead_cart.php?cmd=emptycart'>Click here to empty your cart</a></h2>
          <hr style='width: 800px; margin-left: 0px; height: 6px; background-color: #14BCEB'><br>
	<!-- end .margin --></div>
  <!-- end .container --></div>
 <?php
