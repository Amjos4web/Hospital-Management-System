...
if($resultCount2>0){
	...
	$dynamic_lists .= "<td style='background-color:#CECECE; font-family: Adobe Heiti Std R;'>" . $storeType . "</td>";
     ...
     <div class="margin" id="content">
	  ...
	  <div class="product_formlist">
	   ...
	   <tr>
		...
		<td width="14%" style='background-color:#C5DFFA; font-family: arial black; text-align: center; font-size: 14px'><b>Quantity Available</b></td>
		<td width="12%" style='background-color:#C5DFFA; font-family: arial black; text-align: center; font-size: 14px'><b>Date Added</b></td>
		</tr>
