...
if($resultCount2>0){
	...
	$dynamic_lists .= "<td style='background-color:#CECECE; font-family: Adobe Heiti Std R;'>" . "<a href='admin_products.php?product_id=$product_id' style='font-style: normal; font-family: Adobe Heiti Std R; color: #880000'>Details</a></td>";
	$dynamic_lists .= "</tr>";
	}
}else{
  ...
  <div id="sidebar1"><br>
    ...
    <ul id="navigation2">
     ...
     <div class="margin" id="content">
	  ...
	  <form action="search_others.php" method="GET">
	    <ul>
	   ...
	   <div class="view">
		...
		<tr>
			...
			<td width="12%" style='background-color:#C5DFFA; font-family: arial black; text-align: center; font-size: 14px'><b>Drugs Details</b></td>
		</tr>
