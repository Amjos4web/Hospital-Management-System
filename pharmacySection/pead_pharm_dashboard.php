...
$sql2 = "SELECT * FROM `pead_pharm_req` ORDER BY date_added ASC LIMIT 30";
...
if($resultCount2>0){
	...
	$dynamic_lists .= "<td style='background-color:#CECECE; padding-left: 5px; font-family: Adobe Heiti Std R; font-size: 14px'>" . "<a href='pead_products.php?id=$product_id' style='font-style: normal; font-family: Adobe Heiti Std R; color: #880000'>View Details</a></td>";
	$dynamic_lists .= "</tr>";
...
<title>Welcome Client (A and E Pharmacy)</title>
    ...
    <ul id="navigation2">
     ...
     <div class="margin" id="content">
	  <div class="welcome_message">
	   ...
	   <h1 class="page" style="color: #FFFFFF; font: 18px Arial, Helvetica, sans-serif;">MCH Pharmacy Section</h1>
	 <div id="product_form3">
	  <table width="760px" style="margin-left: auto; margin-right: auto" cellpadding="2" cellspacing="0" border="1">
	   <tr>
		...
		<td width="9%" style='background-color:#C5DFFA; font-family: arial black; text-align: center; font-size: 14px'><b>Type</b></td>
