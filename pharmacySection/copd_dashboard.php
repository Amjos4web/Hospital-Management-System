...
$sql2 = "SELECT * FROM `copd_pharm_req` ORDER BY date_added DESC LIMIT 30";
...
if($resultCount2>0){
	while($row=mysqli_fetch_array($check2)){
		...
		$dynamic_lists .= "<td style='background-color:#CECECE; padding-left: 5px; font-family: Adobe Heiti Std R; font-size: 14px'>" . "<a href='copd_products.php?product_id=$product_id' style='font-style: normal; font-family: Adobe Heiti Std R; color: #880000'>View Details</a></td>";
		$dynamic_lists .= "</tr>";
    ...
    <ul id="navigation2">
     ...
     <div class="margin" id="content">
	  <div class="welcome_message">
	   ...
	   <h1 class="page" style="color: #FFFFFF; font: 18px Arial, Helvetica, sans-serif;">COPD Pharmacy Section</h1>
